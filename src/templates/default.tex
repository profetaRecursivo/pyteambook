...
\documentclass[10pt, {{ paper }}paper, {{ orientation }}]{extarticle}

{% if orientation == 'landscape' %}
\usepackage[left=1.5cm, right=1cm, top=2cm, bottom=1.5cm, headheight=15pt, {{ orientation }}]{geometry}
{% else %}
...
\fancyfoot[C]{\footnotesize {{ university }}}
